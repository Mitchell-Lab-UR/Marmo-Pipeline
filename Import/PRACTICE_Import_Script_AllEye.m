...
if ~exist('DataFolder', 'var')
   ...
   % shank = hardware.electrodeFactory('Nandy64'); %Neuronexus 64 probe(Ellie)
   % shank = hardware.electrodeFactory('ShankA'); %32 Channel Atlas probe
    shank = hardware.electrodeFactory('Nandy64_flip'); % (Milo)
...
switch user
    ...
    case 'practice'
        SERVER_DATA_DIR = 'E:\PRACTICE';
        PROCESSED_DATA_DIR = 'E:\PRACTICE\Processed'; 
end
