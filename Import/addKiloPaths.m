...
switch user
    case 'gravedigger'
       ...
       % marmoPipePath = 'C:\Users\Jake\Dropbox\Marmo Lab Website\PSA\Code';
        marmoPipePath = 'C:\PSA_Gravedigger\Code';
        ...
        setpref('KILOSORT', 'SERVER_DATA_DIR', 'C:\PSA_Gravedigger\Raw')
        
        % where the data live
        dataPath = getpref('KILOSORT', 'SERVER_DATA_DIR');
        
        % processed data:
        setpref('KILOSORT', 'PROCESSED_DATA_DIR', 'C:\PSA_Gravedigger\Processed')
