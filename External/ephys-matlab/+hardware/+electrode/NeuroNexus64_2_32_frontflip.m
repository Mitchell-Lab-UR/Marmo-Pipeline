classdef NeuroNexus64_2_32_frontflip < hardware.electrode.probe
    
    properties
    end
    
    methods        
        function p = NeuroNexus64_2_32_frontflip(varargin)
            ...
            % connector
            omnetics = [rot90(omnetics2,2) omnetics1];
            
            %if we need something that was just front, not front flipped
            % omnetics = [omnetics2 omnetics1];
            % omnetics = [rot90(omnetics2,2) rot90(omnetics1,2)];
