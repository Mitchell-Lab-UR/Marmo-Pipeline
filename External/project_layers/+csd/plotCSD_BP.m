...
% ghs wrote it 2020
    ...
    if numShanks == 1
        ...
        h2 = plot(stats.time([1 end]), [1; 1]*gamma.lgInputLayerDepths(:,1,1), 'black--', 'Linewidth', 2);
    ...
    elseif numShanks > 1
        ...
        h2 = plot(stats.time([1 end]), [1; 1]*gamma.lgInputLayerDepths(:,1,shankInd), 'black--', 'Linewidth', 2);
