...
% This function identifies dead channels by missing ycoords in the LFP
% struct. These would be missing if kilosort excludes it. 
% TODO: find a better way to identify dead channels. 
...
if length(exclude)<exclude_threshold
    ...
    warning('Removing dead channels FAILED. Leaving all channels unchanged.')
